...
public class FunctionTest {
  ...
  @Test
  public void testGetAcccounts() throws Exception {
  ...
  @Test
  public void noOrgSupplied() throws Exception {
    ExampleFunction function = new ExampleFunction();
    Context mockContext = mock(Context.class);

    when(mockContext.getOrg()).then(c -> Optional.empty());

    FunctionOutput output = function.apply(createEventMock(), mockContext);

    assertTrue(output != null);
    assertTrue(!output.getErrorMessage().isEmpty());
    assertTrue(output.getAccounts().isEmpty());
  }
